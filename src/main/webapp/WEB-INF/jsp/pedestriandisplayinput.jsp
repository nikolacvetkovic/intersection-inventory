...
<%@include file="topinput.jsp" %>
                            <form class="login-page" action="pedestriandisplayinput" method="post">
                                <div class="login-header margin-bottom-30">
                                    
                                </div>
                                <div class="input-group margin-bottom-20">
                                    Raskrsnica: <select class="form-unos" name="idInt" onchange="if(this.value!=-1) window.location='./pedestriandisplayinput?idInt='+this.value">
