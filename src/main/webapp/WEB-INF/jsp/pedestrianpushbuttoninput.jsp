...
<%@include file="sideMenu.jsp" %>
                            ...
                            <form class="login-page" action="pedestrianpushbuttoninput" method="post">
                                <div class="login-header margin-bottom-30">
                                    
                                </div>
                                <div class="input-group margin-bottom-20">
                                    Raskrsnica: <select class="form-unos" name="idInt" onchange="if(this.value!==-1) window.location='./pedestrianpushbuttoninput?idInt='+this.value">
                                ...
                                <div class="input-group margin-bottom-20">
                                    Oznaka tastera: <input class="form-oznaka" type="text" name="symbol"/>
                                </div>
                                <div class="input-group margin-bottom-20">
                                    Zvučna potvrda najave: <input class="form-oznaka" type="text" name="sound"/>
                                </div>
                                <div class="input-group margin-bottom-20">
                                    Svetlosna potvrda najave: <input class="form-oznaka" type="text" name="light"/>
                                </div>
                                <div class="input-group margin-bottom-20">
                                    Lokator ton: <input class="form-oznaka" type="text" name="locatortone"/>
                                </div>
                                <div class="input-group margin-bottom-20">
                                    Proizvođač: <input class="form-proiz1" type="text" name="manufacturer"/>
                                </div>
                                <div class="input-group margin-bottom-20">
                                    Model: <input class="form-proiz1" type="text" name="modelPed"/>
                                </div>
